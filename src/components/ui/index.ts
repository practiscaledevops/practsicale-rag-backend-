...
// Bulk actions (select many rows → act on all). Pure helpers — runBulk,
// runChunks, chunk, requestJson, BULK_MAX_IDS, BULK_CONCURRENCY — live in @/lib/bulk.
export {
  BulkActionBar,
  BulkProgress,
  SelectAllCheckbox,
  ...
  type BulkRunState,
  type BulkRunOptions,
  type BulkPoolOptions,
  type BulkChunkOptions,
  type BulkIdWorker,
  type BulkBatchSender,
  type RowSelection,
  type ToggleOptions,
